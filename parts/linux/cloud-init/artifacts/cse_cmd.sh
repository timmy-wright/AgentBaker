...
LOCAL_DNS_GENERATED_CORE_FILE="{{GetLocalDNSCoreFileFromTemplate}}"
AKS_LOCAL_DNS_ENABLED="{{IsAKSLocalDNSEnabled}}"
AKS_LOCAL_DNS_IMAGE_URL="{{GetLocalDNSImageUrl}}"
AKS_LOCAL_DNS_NODE_LISTENER_IP="{{GetNodeListenerIP}}"
AKS_LOCAL_DNS_CLUSTER_LISTENER_IP="{{GetClusterListenerIP}}"
DEFAULT_UPSTREAM_DNS_SERVER_IP="{{GetUpstreamDNSServerIP}}"
